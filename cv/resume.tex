...
Software engineering, Certification engineering, software dependability and security, fault injection testing, fuzz testing, trusted computing
...
\textbf{CEO and Co-Founder}\hfill\\
\vspace{-3mm}\\\vspace{-1mm}
\begin{list2}
	\item \filbreak\textit{WAVY MEET platform:} Born from ``OWL - FNR JUMP project'', it's a medical software platform with a secure and comprehensive approach to remote rehabilitation.
	\item \filbreak\textit{FIT4START \#13 awards:} One of the 20 selected startups, from a total of 214 applications coming from 42 countries, awarded with specialized coaching as well as €50,000 of funding from the Ministry of the Economy each, with an additional €100,000 for the successfully graduation from the program and injection of private capital.
...
\begin{list2}
	...
	\item \filbreak\textit{AI for transport \& logistic - Luxembourgish R\&D project}: Project Manager and Scientist of the agreement between SnT (project partner) and Gulliver Luxembourg S.à r.l. (project leader). The project aims to improve software for the transport and logistic services with the aid of novel AI technologies.
\end{list2}
